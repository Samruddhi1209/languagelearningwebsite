...
const drop = (e) => {
  ...
  if (isTouchDevice()) {
    ...
    if (
      ...
      count += 1;
      // Play audio for the spelling
      const audioElement = document.getElementById("spellingAudio");
      audioElement.src = `${currentElement.id}.mp3`;
      audioElement.play();
    }
    ...
    if (draggedElementData === droppableElementData) {
      ...
      count += 1;
     // Play audio for the spelling
     const audioElement = new Audio(`${draggedElementData}.mp3`);
     audioElement.play();
    }
  }
  //Win
  if (count == 3) {
    result.innerText = `Hurrayy You Won!`;
    stopGame();
  }
};
